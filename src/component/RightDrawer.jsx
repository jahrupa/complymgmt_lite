...
export default function RightDrawer({ pdfFile, isPdfView, toggleDrawer, drawerHeader, drawerBody, drawerFilePreviewHeader, drawerFilePreviewBody, isModalOpen, width = '500px' }) {
    const DrawerList = (

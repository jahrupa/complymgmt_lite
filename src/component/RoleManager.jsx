...
const RoleManager = () => {
  ...
  const accessControl = ["Upload/Add New", "Edit", "Delete", "Can Approve"];
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [userData, groupHolding] = await Promise.all([
          fetchAllRole(),
          fetchAllGroupHolding(),
        ]);
        setData(userData);
  ...
  const colDefs = [
    ...
    {
      field: "common_attributes.approval_time",
      ...
      <div>
        ...
        <div className="d-lg-flex d-md-flex justify-content-between  gap-3">
          <SingleSelectTextField
            name="access Level"
            label="Access Level"
            value={current.access_modules}
            onChange={(e) =>
              setCurrent((prev) => ({
                ...prev,
                access_modules: e.target.value,
              }))
            }
            names={accessLevel}
            isdisable={true}
          ...
          <div className="col-6 d-flex justify-content-end">
            ...
            >
              {isEditing ? (
                ...
                <span className="button-style">Create User Role</span>
              )}
            </button>
          </div>
        </div>
      ...
      <div className="row  mb-4 mt-4">
        <div className="col col-12 col-lg-4 mb-3 col-md-4">
          <div className="card_div p-3 w-auto card-border-blue">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="fs-14 fw-600 icon-color">120</div>
              <div>
                <div>
                  <MenuPopup />
                </div>
        ...
        <div className="col col-12 col-lg-4 mb-3 col-md-4">
          <div className="card_div p-3 w-auto card-border-red">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="fs-14 fw-600 inactive-color">20</div>
              <div>
                <div>
                  <MenuPopup />
                </div>
          ...
          <div className="d-lg-flex d-md-flex  justify-content-end mb-3">
            <div>
              <button className="crud_btn w-100" onClick={openModal}>
                ...
                <span className="button-style">Add New User Role</span>
              </button>
            </div>
            <DeleteModal

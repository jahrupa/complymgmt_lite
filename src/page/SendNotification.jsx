...
import { fetchAllUser, createUser, updateUserById, uploadFileGolang, fetchAllFiles, deleteFileById, updateFileById, bulkApproveAllPageData } from '../api/service';
            ...
            <div className='service-tracker-inner-page-header d-lg-flex d-md-flex'>
                ...
                <div className='d-lg-flex d-md-flex gap-2 mt-2'>
                    ...
                    <div className='btn-wrap-div'>
                        <button className="button approve w-100 justify-content-center" onClick={''}>
                            <span className="icon">
                                <svg viewBox="0 0 24 24">
